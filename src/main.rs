...
//Port Sniffer is a CLI tool to check open ports on a ip address
//  Run `cargo run -- -h` to see available options (help command and output automatically generated by bpaf)
//  HIGHLY RECOMMENDED NOT TO USE ON PUBLIC NETWORKS OR SERVERS AS THEY MIGHT BLACKLIST YOU 
